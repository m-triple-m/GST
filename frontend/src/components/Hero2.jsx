...
import { ArrowDown, MapPin, Users, Calendar, Award } from 'lucide-react';
  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div ref={ref} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-24 w-full flex flex-col items-center text-center">
        ...
        {/* Stats row */}
        <div
          className={`grid grid-cols-2 lg:grid-cols-4 gap-4 w-full max-w-4xl transition-all duration-700 ${
            visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
